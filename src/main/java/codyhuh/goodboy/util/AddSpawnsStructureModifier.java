...
// Code for Add Spawns structure mod snagged with permission from skyjay1's Greek Fantasy mod, licensed under LGPLv3
public class AddSpawnsStructureModifier implements StructureModifier {
    ...
    public Codec<? extends StructureModifier> codec() {
        return ModStructureModifiers.ADD_SPAWNS_MODIFIER.get();
    }
}