...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<Retriever>> RETRIEVER = ENTITY_TYPES.register("retriever", () -> EntityType.Builder.of(Retriever::new, MobCategory.CREATURE).sized(0.7F, 0.8F).build("retiever"));
    public static final RegistryObject<EntityType<Chihuahua>> CHIHUAHUA = ENTITY_TYPES.register("chihuahua", () -> EntityType.Builder.of(Chihuahua::new, MobCategory.CREATURE).sized(0.3F, 0.4F).build("chihuahua"));
