...
public class ModItems {
    ...
    public static final RegistryObject<Item> CHIHUAHUA_SPAWN_EGG = ITEMS.register("chihuahua_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.CHIHUAHUA, 0x6b4127, 0xd38b4e, new Item.Properties()));
